...
public class EscrituraSecuencialPropietario {
    private String nombreArchivo;
    private ObjectOutputStream salida;
    private Propietario propietario;
    
    public EscrituraSecuencialPropietario(String nombreArc) {
    ...
    public void establecerSalida() {
        ...
        try {
            ...
            salida.writeObject(propietario); // envía el registro como 
            // objeto al archivo
            salida.close();
